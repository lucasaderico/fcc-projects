...
function calculateCalories(e) {
  ...
  const lunchNumberInput = document.querySelectorAll(
    "#lunch input[type=number]",
  );
  const dinnerNumberInput = document.querySelectorAll(
    "#dinner input[type=number]",
  );
  const snacksNumberInput = document.querySelectorAll(
    "#snacks input[type=number]",
  );
  const exerciseNumberInput = document.querySelectorAll(
